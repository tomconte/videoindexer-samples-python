...
class UploadFacesContract(object):
    ...
    def __init__(self, urls=None):  # noqa: E501
        """UploadFacesContract - a model defined in Swagger"""  # noqa: E501
        self._urls = None
    ...
    @property
    def urls(self):
        """Gets the urls of this UploadFacesContract.  # noqa: E501


        :return: The urls of this UploadFacesContract.  # noqa: E501
        :rtype: list[str]
        """
        return self._urls
    ...
    @urls.setter
    def urls(self, urls):
        """Sets the urls of this UploadFacesContract.


        :param urls: The urls of this UploadFacesContract.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UploadFacesContract, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UploadFacesContract):
            return False
