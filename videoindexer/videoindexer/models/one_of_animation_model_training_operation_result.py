...
class OneOfAnimationModelTrainingOperationResult(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfAnimationModelTrainingOperationResult - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfAnimationModelTrainingOperationResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfAnimationModelTrainingOperationResult):
            return False
