...
class AudioEffectType(object):
    ...
    SIRENWAILING = "SirenWailing"
    SIRENORALARM = "SirenOrAlarm"
    GUNSHOTOREXPLOSION = "GunshotOrExplosion"
    UNLABELED = "Unlabeled"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """AudioEffectType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AudioEffectType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudioEffectType):
            return False
