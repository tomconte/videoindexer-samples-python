...
class OneOfVideoLanguageDominantLanguage(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfVideoLanguageDominantLanguage - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfVideoLanguageDominantLanguage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfVideoLanguageDominantLanguage):
            return False
