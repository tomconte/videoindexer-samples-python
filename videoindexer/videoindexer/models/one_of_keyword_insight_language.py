...
class OneOfKeywordInsightLanguage(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfKeywordInsightLanguage - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfKeywordInsightLanguage, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfKeywordInsightLanguage):
            return False
